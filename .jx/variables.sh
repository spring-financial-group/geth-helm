...
export JENKINS_X_URL='https://dashboard-jx.jx.mqube.build/spring-financial-group/geth-helm/HEAD/1'
...
export MINK_IMAGE='jx3mqubebuild.azurecr.io/spring-financial-group/geth-helm:0.0.5'
